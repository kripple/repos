...
export function SvgIcon({ icon, id }: { icon: 'sun' | 'moon'; id: string }) {
  const drawpath = icon === 'moon' ? moon : icon === 'sun' ? sun : '';

  return (
    <svg aria-hidden="true" focusable="false" id={id} viewBox="0 0 24 24">
